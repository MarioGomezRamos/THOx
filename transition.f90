...
!      namelist /trans/ mp,mt,zt,zp,rcc,namep,namet
      ...
      namelist /coupling/ qcmin,qcmax,kcmax,lamax,coups,ncoul
      namelist /BEQ/ bel
!      interface
...
!      write(*,400) nqmin,nqmax,0,min(kmax,kcmax),0,lambmax
      write(*,400) nqmin,nqmax,0,kmax,0,lambmax
...
c *** ---------------------------------------------------------
      ...
      use xcdcc,only:nquad,rquad,frad,exch,parch,jpch,nex
...
!      do i=1,nr
!       xrvec=rfrag(i)
!        write(99,*)xrvec,VCOUL(xrvec,zfrag,zt,rcc)
!      endif
!      stop
